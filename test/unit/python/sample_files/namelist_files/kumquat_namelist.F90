...
module kumquat_namelist
   ...
   integer, public, parameter   :: cam_nl_autogen1_dimension = 2
   real(kind_phys), public, protected :: kq_farr1(2) = -HUGE(1.0_kind_phys)
   integer, public, parameter   :: cam_nl_autogen2_dimension = 3
   integer, public, parameter   :: cam_nl_autogen3_dimension = 2
   integer, public, protected :: kq_fake2(3, 2) = unset_int
   integer, public, parameter   :: cam_nl_autogen4_dimension = 7
